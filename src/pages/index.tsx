  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application - Streamlining your HR processes, empowering your workforce, and enabling your business to reach its full potential."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application - Streamlining your HR processes, empowering your workforce, and enabling your business to reach its full potential.`}
            </Text>
            <Box
